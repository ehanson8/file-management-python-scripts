...
parser.add_argument('-d', '--directory', help='the file path of name changes. \
...
if args.makeChanges:
    ...
    the directories (otherwise, it will only create a log of the expected \
            ...
            for row in reader:
                ...
                if dir == oldFolder:
                    ...
                    if makeChanges == 'true':
                        ...
                        print('log of expected directory name changes created \
                        only, no files renamed')
